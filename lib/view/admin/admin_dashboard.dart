...
Widget _curtainTable(BuildContext context ,List curtainList) {
                ...
                rows: List.generate(curtainList.length, (i) {
                  ...
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(r['title_contents'].toString().length > 15 ? '${r['title_contents'].toString().substring(0,15)}...': r['title_contents'].toString())),
                      ...
                      DataCell(
                        SizedBox(
                          width: 160,
                          child: Text(
                            r['curtain_desc'].toString().length > 10 ? '${r['curtain_desc'].toString().substring(0,15)}...':r['curtain_desc'].toString(),
                      ...
                      DataCell(
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              // Navigator.push(context, MaterialPageRoute(builder: (context) => AdminCurtainEdit(initialData: initialData),));
                            },
                            child: const Text(
                              '수정',
                              maxLines: 1,
  ...
  // ---------------- Sidebar ----------------
  Widget _sideBar(BuildContext context,WidgetRef ref, AsyncValue<DashBoardState> dashboardAsync) {
  ...
  Widget _sideItem(WidgetRef ref, String title, {required int index, required int selectedIndex}) {
