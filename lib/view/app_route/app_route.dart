...
class AppRoute {
  ...
  static const userInfoUpdate = '/user_info_update'; // 회원 정보 수정
  static const userMypage = '/user_mypage'; // 마이 페이지
  static const tabBar = '/tab_bar'; // 메인 페이지 탭바
  static const main = '/main_page';
  static const category = '/category'; // 카테고리
  static const curtainList = '/curtainList'; // 뮤지컬 리스트
  static const ticketList = '/ticket_list'; // 티켓 상세 페이지
  static const ticketListOption = '/ticket_list_option'; // 티켓 상세 페이지
  ...
  static const purchaseDetail = '/purchase_history_detail'; // 구매 이력 상세
  ...
  static const userToUserChat = '/review_list'; // 관람 후기 내역

  static const curtainDetail = '/curtain_detail'; // 공연 정보 페이지
  static const ticketDetail = '/ticket_detail'; // 티켓 상세 페이지
  static const sellerToAdminChat = '/seller_to_admin_chat'; // 관리자 문의 채팅
  static const transactionReviewWrite = '/transaction_review_write'; // 거래 후기 작성
  static const transactionReviewList = '/transaction_review_list'; // 거래 후기 내역
  static const shoppingCart = '/shopping_cart'; // 찜하기

  // ===== ADMIN =====
  static const adminLogin = '/admin_login'; // 관리자 로그인
  static const adminDashboard = '/admin_dashboard'; // 관리자 대시보드
  static const adminCurtainEdit = '/admin_curtain_edit'; // 뮤지컬 정보 수정
  static const faqList = '/faq_list';
  static const boardWrite = '/board_write'; // 게시판 글 쓰기
  static const boardEdit = '/board_edit'; // 게시판 글 수정
  static const adminTransactionManage = '/admin_transaction_manage'; // 거래글 관리
  static const adminReviewManage = '/admin_review_manage'; // 관람 후기 관리
  static const adminTransactionReviewManage =
      '/admin_transaction_review_manage'; // 거래 후기 관리
  static const adminChatList = '/admin_chat_list'; // 고객 채팅 리스트
  static const adminChatDetail = '/admin_chat_detail'; // 고객 채팅 화면
}
