class Curtain {
  ...
  Curtain({
    ...
    required this.curtain_cast,
    required this.curtain_place,
    required this.curtain_type,
    required this.curtain_location,
  ...
  factory Curtain.fromJson(Map<String, dynamic> json){
    return Curtain(
      ...
      curtain_cast: json['curtain_cast'] ?? '',
      curtain_place: json['place_name'] ?? '',
      curtain_type: json['type_name'] ?? '',
      curtain_location: json['location_name'] ?? '',
  ...
  Map<String, dynamic> toJson(){
    return{
      ...
      'curtain_cast' : curtain_cast,
      'curtain_place' : curtain_place,
      'curtain_type' : curtain_type,
      'curtain_location' : curtain_location,
